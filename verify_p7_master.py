...
gre("P8-6: Fig-5 caption states same configuration as Fig-4", r'same configuration and pipeline as [Ff]igure')
gre("P8-6: 'Reading Figure' commentary paragraph present", r'\\paragraph\{Reading [Ff]igure')
...
gre("P8-7: A1 intent: 'verified numerically' in at least two places", r'verified numerically')
gre("P8-7: A1 ratified phrase present at least once (recommended in both contribution (ii) and Sec 11)", r'verified numerically against the exact \(closed-form\) Bohmian field')
