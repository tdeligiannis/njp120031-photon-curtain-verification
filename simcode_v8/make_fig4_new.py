"""Fig 4: forward-modeled reconstruction at Config E through the GLS pipeline (v8.1; Na=1e7 characterization)."""
...
a.axhline(0.33*420.3,color='gray',ls=':',lw=1); a.text(6,0.33*420.3*1.08,'1/3 of fringe',fontsize=7.5,color='gray')
