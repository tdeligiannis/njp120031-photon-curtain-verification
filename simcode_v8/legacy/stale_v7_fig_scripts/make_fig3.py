...
Lam100   = 1.131e-2          # Lambda_eff at F=100, Config E
Lam_sp   = 9.50e-5           # single-pass Config-D-optics reference (two-level, Table 2 ref block)
...
ax.plot(1, Na_sp10, marker='s', ms=7, mfc='w', mec='k', mew=1.2, ls='none', zorder=6,
        label=fr'single pass, Config-D optics ($N_a\approx1.1\times10^6$)')
